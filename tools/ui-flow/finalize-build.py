"""Finalize the isolated UI-06 web preview; keep engine diagnostics, hide stats HUD."""
import argparse
...
shutil.copy2(repo / 'assets/ui-flow/OFL.txt', root / 'OFL.txt')
shutil.copy2(repo / 'assets/ui-flow/NOTICE.txt', root / 'FONT-NOTICE.txt')
print('UI-06 preview finalized:', root)
