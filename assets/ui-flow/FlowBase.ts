...
@ccclass('MMUIFlowBase')
export class MMUIFlowBase extends Component {
  ...
  protected resumes=0;
  protected selected='';
  protected notice='UI-06 演示数据 · 不写入正式存档';
  ...
  protected override onDestroy():void {
    ...
    if(typeof window!=='undefined') delete (window as unknown as Record<string,unknown>).__UI_FLOW__;
  }
  ...
  protected render():void {
    ...
    this.text(this.stage,'HarnessCaption','UI-06 · 页面与状态预览',375,26,700,32,22,C.muted);
    this.renderContent();
    ...
    if(typeof window!=='undefined')(window as unknown as Record<string,unknown>).__UI_FLOW__={
