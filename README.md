...
最新UI交付：[UI-08设计阶段已完成](docs/17_UI_RELEASE_READINESS.md)。现有页面/百关审查的精简web构建与视觉回归通过，资源保持同源；[页面流程](http://127.0.0.1:62320/)、[百关布局](http://127.0.0.1:62330/)仅本机开放。按D025，正式玩法、平台、美术及安卓验收在后续代码开发阶段执行。
...
UI-06 最新成果：[页面与状态预览](docs/15_UI_FLOW_PREVIEW.md)。UI-05已由所有者验收通过；新增地图、准备、图鉴、外观、设置及异常恢复视图，真实玩法与平台功能绑定另行推进。
